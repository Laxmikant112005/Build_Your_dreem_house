...
module.exports = {
  ...
  // Fail fast to prevent token forgery when env vars are missing.
  jwt: {
    secret: mustHave(jwtSecret, 'JWT_SECRET'),
    refreshSecret: mustHave(jwtRefreshSecret, 'JWT_REFRESH_SECRET'),
