...
router.post('/', authenticate, validateJoi(reviewValidator.addReview, 'body'), reviewController.createReview);
...
router.post('/:id/respond', authenticate, validateJoi(reviewValidator.respondToReview, 'body'), reviewController.respondToReview);
