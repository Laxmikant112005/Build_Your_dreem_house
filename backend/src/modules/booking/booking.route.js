...
// Keep existing external validators but prefer module-level Joi where available
router.get('/my-bookings', authenticate, bookingController.getMyBookings);
router.post('/', authenticate, validateJoi(bookingValidator.createBooking, 'body'), validate, bookingController.createBooking);
