...
router.post('/', validateJoi(chatValidator.sendMessage, 'body'), validate, chatController.createChat);
router.get('/:id/messages', param('id').isMongoId(), validate, chatController.getMessages);
router.post('/:id/messages', param('id').isMongoId(), validateJoi(chatValidator.sendMessage, 'body'), validate, chatController.sendMessage);
