...
router.put('/designs/:id/reject', param('id').isMongoId(), validateJoi(adminValidator.moderateAction, 'body'), validate, adminController.rejectDesign);

// Engineer management
router.put('/engineers/:id/verify', param('id').isMongoId(), validateJoi(adminValidator.moderateAction, 'body'), validate, adminController.verifyEngineer);
