...
const antigravityRoutes = require('../modules/antigravity/antigravity.route');
const scienceRoutes = require('../modules/science/science.route');
const fieldRoutes = require('../modules/field/field.route');
const modelInfoRoutes = require('../modules/model-info/model-info.route');
...
router.use(`/${config.apiVersion}/antigravity`, antigravityRoutes);
router.use(`/${config.apiVersion}/science`, scienceRoutes);
router.use(`/${config.apiVersion}/model-info`, modelInfoRoutes);
