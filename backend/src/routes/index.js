...
router.use(`/${config.apiVersion}/engineer/blueprints`, blueprintRoutes);
router.use(`/${config.apiVersion}/engineer`, engineerRoutes);
router.use('/engineer/blueprints', blueprintRoutes);
